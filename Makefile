...
#    Updated: 2020/03/01 17:24:45 by pstein           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CLEM_IN= main.c functions.c read_struct.c funct1.c funct2.c funct3.c funct4.c create_list.c checks.c operations.c variables.c functions2.c read_commands.c errors.c
